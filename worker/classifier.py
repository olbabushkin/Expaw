...
_SYSTEM = (
    ...
    "или предложение, а не просто упоминает тему. Сообщение относится максимум "
    "к ОДНОМУ интенту: если подходит несколько, поставь match=true только самому "
    "подходящему, остальным — match=false. reason — одно короткое предложение "
    "на русском."
)
